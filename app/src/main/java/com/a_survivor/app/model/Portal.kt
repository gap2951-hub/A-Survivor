...
object PortalRegistry {
    fun portalsFor(mapType: MapType): List<Portal> = when (mapType) {
        ...
        MapType.BEGINNER_FIELD -> listOf(
            Portal(880f,  80f, MapType.TOWN,    350f, 286f, "마을"),
            Portal(144f,  80f, MapType.FIELD_2, 800f, 100f, "중급 사냥터")
        )
        MapType.TOWN -> listOf(
            Portal(250f, 286f, MapType.BEGINNER_FIELD,   860f, 100f, "초보자 사냥터"),
            Portal(750f, 286f, MapType.MINOTAUR_FIELD_1, 300f, 286f, "미노타우르스 사냥터")
        )
        MapType.FIELD_2 -> listOf(
            Portal(880f,  80f, MapType.BEGINNER_FIELD, 160f, 100f, "초보자 사냥터"),
            Portal(144f,  80f, MapType.FIELD_3,        800f, 100f, "상급 사냥터")
        )
        MapType.FIELD_3 -> listOf(
            Portal(880f,  80f, MapType.FIELD_2, 160f, 100f, "중급 사냥터")
        )
